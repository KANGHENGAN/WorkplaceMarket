-- 分类数据
INSERT INTO category (id, name) VALUES (1, '办公用品') ON DUPLICATE KEY UPDATE name = VALUES(name);
INSERT INTO category (id, name) VALUES (2, '电子产品') ON DUPLICATE KEY UPDATE name = VALUES(name);
INSERT INTO category (id, name) VALUES (3, '员工福利') ON DUPLICATE KEY UPDATE name = VALUES(name);
INSERT INTO category (id, name) VALUES (4, '生活用品') ON DUPLICATE KEY UPDATE name = VALUES(name);
INSERT INTO category (id, name) VALUES (5, '礼品卡券') ON DUPLICATE KEY UPDATE name = VALUES(name);
INSERT INTO category (id, name) VALUES (6, '书籍读物') ON DUPLICATE KEY UPDATE name = VALUES(name);
INSERT INTO category (id, name) VALUES (7, '健康保健') ON DUPLICATE KEY UPDATE name = VALUES(name);
INSERT INTO category (id, name) VALUES (8, '工作装备') ON DUPLICATE KEY UPDATE name = VALUES(name);
